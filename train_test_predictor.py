...
def train_and_test(model, X, y, groups, param_grid, notes):
    ...
    # create multiple train/test splits of data
    # Note: if we are using the data in long format, we must do group
    #       splitting based on the player name
    gss = GroupShuffleSplit(n_splits=3, test_size=0.33, random_state=42)
